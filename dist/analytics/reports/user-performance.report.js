...
exports.UserPerformanceReport = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const analytics_data_entity_1 = require("../entities/analytics-data.entity");
let UserPerformanceReport = class UserPerformanceReport {
    ...
    async calculateUserMetrics(userId, startDate, endDate, params) {
    ...
    calculateTradingFrequency(totalTrades, startDate, endDate) {
        const days = Math.ceil((endDate.getTime() - startDate.getTime()) / (1000 * 60 * 60 * 24));
        return days > 0 ? totalTrades / days : 0;
    }
    async getHistoricalPerformance(userId, startDate, endDate, period) {
    ...
    async getLeaderboardPosition(userId, startDate, endDate) {
    ...
    async getPerformanceBreakdown(userId, startDate, endDate) {
...
exports.UserPerformanceReport = UserPerformanceReport;
exports.UserPerformanceReport = UserPerformanceReport = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(analytics_data_entity_1.AnalyticsData)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], UserPerformanceReport);
//# sourceMappingURL=user-performance.report.js.map