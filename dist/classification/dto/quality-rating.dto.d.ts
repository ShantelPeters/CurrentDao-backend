...
declare const UpdateQualityRatingDto_base: import("@nestjs/common").Type<Partial<CreateQualityRatingDto>>;
...
declare const UpdateCertificationDto_base: import("@nestjs/common").Type<Partial<CreateCertificationDto>>;
